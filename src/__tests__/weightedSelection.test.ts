...
describe('Power-up selection integration', () => {
  it('POWERUP_CONFIGS weights sum to expected total', () => {
    // Currently 183: balloon(20) + cake(15) + drinks(15) + disco(10) + mystery(10) +
    // powerball(12) + fireball(10) + electricball(12) + partypopper(10) + bassdrop(8) +
    // djscratch(12) + bouncehouse(10) + partyfavor(3) + confetticannon(10) + congaline(8) +
    // spotlight(8) + dancefloor(10)
    expect(getTotalDropWeight()).toBe(183);
  });
